...
The calculations work a little differently with 2 predictor variables. Sum of squares total 'SST' (which is our proxy measure of variance) is split as follows:
...
Interactions, but without main effects:
```{r}
```